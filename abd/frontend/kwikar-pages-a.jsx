...
// ── Add Technician Modal (WhatsApp referral link) ───────────────────────
      ...
      <div style={{
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:16 }}>
          <div>
            ...
            <p style={{ fontSize:12, color:'#64748b', margin:'4px 0 0' }}>Referral link share karo — woh aapke network mein automatically add ho jayega</p>
          </div>
        ...
        <div style={{ display:'flex', gap:10, padding:'12px 14px', borderRadius:12, background:'rgba(255,90,31,0.06)', border:'1px solid rgba(255,90,31,0.15)', marginBottom:20 }}>
          ...
          <div style={{ fontSize:12, color:'#92400e', lineHeight:1.55 }}>
            Technician is link se register karega toh woh seedha aapke <strong>Direct Technicians</strong> list mein aayega aur aapko subscription commission milegi.
          </div>
        </div>
